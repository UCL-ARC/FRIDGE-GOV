...
| **Front Door TRE Security** | • Operate Front Door TRE<br/>• Implement infrastructure management<br/>• Manage study/project processes<br/>• Maintain TRE capabilities | • <br/> • <br/> • <br/> • | [Front Door TRE Boundary](../FRIDGE_Governance_Extension_Architecture.md#33-front-door-tre-boundary) |
