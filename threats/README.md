# FRIDGE Threat Modeling

This folder contains threat modeling for FRIDGE, to inform security controls.

The primary reason for threat modeling FRIDGE is to understand how risks can be mitigated with a combination of HPC facility and FRIDGE security controls, and thus define the required security posture for the HPC tenancies.
